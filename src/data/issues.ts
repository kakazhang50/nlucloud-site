 ...
 * Reading order: judgment → representation → learning → time (experience → structure) → creative motives.
...
export const coreIssues: MagazineIssue[] = [
  {
    ...
    editorLede:
      'AI can generate ten drafts in a minute. The binding constraint is no longer production — it is knowing which draft deserves to carry your name, your institution, and your consequence.',
    status: 'published',
  ...
  },
  {
    ...
    editorLede:
      'When outputs feel generic, we blame the model. Often the failure is co-produced earlier — at the boundary between what we mean and what we are willing to write down.',
    status: 'published',
  ...
  },
  {
    ...
    editorLede:
      'AI’s deeper role in education is not more content. It is orchestration — selecting, sequencing, and combining learning models under limited cognitive energy.',
    status: 'published',
  ...
  },
  {
    ...
    editorLede:
      'AI is sold as speed. Daily use still brings spinners and half-loaded pauses. Before we ask who waits longer, we must name what waiting does to attention itself.',
    status: 'published',
  ...
  },
  {
    ...
    editorLede:
      'The Waiting Tax names lived experience. The Latency Tax asks who bears delay, whose time is commodified, and how responsiveness shapes access.',
    status: 'published',
  ...
  },
  {
    ...
    editorLede:
      'Generative AI is framed as a threat to creativity. A clearer frame: expression, feedback, and outcome always coexisted — AI changes what each costs to act on.',
    status: 'published',
